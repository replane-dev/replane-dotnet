...
/// </summary>
internal static class ReplaneConstants
{
    /// <summary>
    /// The context key for the auto-generated client ID.
    /// </summary>
    public const string ReplaneClientIdKey = "replaneClientId";
}
...
public sealed class ReplaneClient : IReplaneClient, IAsyncDisposable
{
    ...
    private readonly ReplaneContext _effectiveContext;
    ...
    public ReplaneClient(ReplaneClientOptions? options = null)
    {
        ...
        var autoGeneratedContext = new ReplaneContext
        {
            [ReplaneConstants.ReplaneClientIdKey] = Guid.NewGuid().ToString()
        };
        _effectiveContext = autoGeneratedContext.Merge(_options.Context);

        _logger.LogDebug($"Initializing ReplaneClient with options:");
        _logger.LogDebug($"  Debug: {_options.Debug}");
        _logger.LogDebug($"  Generated replaneClientId: {_effectiveContext[ReplaneConstants.ReplaneClientIdKey]}");
        if (_options.Context != null && _options.Context.Count > 0)
        {
            _logger.LogDebug($"  User-provided context: {FormatContext(_options.Context)}");
        }
    ...
    public T? Get<T>(string name, ReplaneContext? context = null, T? defaultValue = default)
    {
        ...
        var mergedContext = _effectiveContext.Merge(context);
